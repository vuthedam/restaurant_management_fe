const AuthLayout = ({ leftSide, children }) => {
  return (
    <div className="flex min-h-dvh w-full items-center justify-center overflow-x-hidden bg-background px-4 py-8 sm:px-6 sm:py-10 lg:px-8 lg:py-12">
      <main className="flex w-full max-w-7xl flex-col overflow-hidden rounded-2xl bg-white border border-slate-200/60 shadow-sm lg:max-h-[min(900px,calc(100dvh-5rem))] lg:min-h-[min(560px,calc(100dvh-5rem))] lg:flex-row">
        {leftSide}
